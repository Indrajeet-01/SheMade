...
from .views import subcategory_products, about_us,  blogs, contact,search_view, add_to_cart, view_cart, cart, remove_from_cart,product_detail,ShopView, ProductListView, dummy
